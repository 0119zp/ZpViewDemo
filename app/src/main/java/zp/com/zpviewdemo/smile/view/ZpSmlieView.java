package zp.com.zpviewdemo.smile.view;
...
public class ZpSmlieView extends LinearLayout implements Animator.AnimatorListener{
    ...
    public ZpSmlieView setDefalutBottom(int defalutBottom) {
    ...
    public ZpSmlieView setDividerMargin(int dividerMargin) {
    ...
    public ZpSmlieView(Context context) {
        this(context, null);
    }

    public ZpSmlieView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ZpSmlieView(Context context, AttributeSet attrs, int defStyleAttr) {
